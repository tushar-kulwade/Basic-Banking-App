...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.tkdeveloper.basicbankingapp.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.tkdeveloper.basicbankingapp.ViewHolder.ClickListener clickListener){
