...
public class history_list extends AppCompatActivity {
    ...
    private void showData() {
        ...
        Cursor cursor = new com.tkdeveloper.basicbankingapp.DatabaseHelper(this).readtransferdata();
        ...
        adapter = new CustomerAdapter_history(com.tkdeveloper.basicbankingapp.history_list.this, modelList_historylist);
